...
public class SuiKe {
    ...
    public static final String VERSION = "Bate-1.2.15";
    ...
    public static void PostInit(FMLPostInitializationEvent event) {
        ...
        if (ConfigValue.spawnCherryBiome) {
            ...
            ForgeRegistries.BIOMES.register(
                new CherryBiome().setRegistryName("suikecherry:suike_cherry_grove")
            );
        }
    ...
    public static void onTextureStitchPre(TextureStitchEvent.Pre event) {
        event.getMap().registerSprite(new ResourceLocation("suikecherry:particle/cherry_particle"));
    }
}