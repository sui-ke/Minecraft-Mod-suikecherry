...
public class SuiKe {
    ...
    public static void PreInit(FMLPreInitializationEvent event) {
        if (!server) {
            ...
            isZhCn = language.equals("zh_cn");
            if (!isZhCn) {
                isZhCn = language.equals("zh_tw");
            }
    ...
    public static void PostInit(FMLPostInitializationEvent event) {
        ...
        if (ConfigValue.spawnCherryBiome) {
            /*注册生物群系*/ForgeRegistries.BIOMES.register(new CherryBiome().setRegistryName("suikecherry:suike_cherry_grove"));
            CherryBiome.初始化生成位置();
        }
