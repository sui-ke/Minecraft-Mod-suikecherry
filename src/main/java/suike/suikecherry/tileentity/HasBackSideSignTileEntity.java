...
// 存储渲染位置
    ...
    private AxisPosition getTextRenderPos(int slot) {
        if (slot == 0)
    ...
    private void setTextRenderPos(int slot, AxisPosition renderPos) {
        if (slot == 0)
...
// 渲染位置
    private static final Map<Integer, AxisPosition> SIGN_ROTATION_MAP = ImmutableMap.<Integer, AxisPosition>builder()
    ...
    private static final Map<Integer, AxisPosition> SIGN_ROTATION_WALL_MAP = ImmutableMap.<Integer, AxisPosition>builder()
    ...
    private static final Map<Integer, AxisPosition> HANG_ING_SING_ROTATION_MAP = ImmutableMap.<Integer, AxisPosition>builder()
