...
public class CraftRecipe {
    ...
    public static void register() {
        ...
        // 樱花木运输船
        GameRegistry.addShapedRecipe(
            new ResourceLocation(SuiKe.MODID, "cherry_chest_boat"),
            new ResourceLocation(SuiKe.MODID),
            new ItemStack(ItemBase.CHERRY_CHEST_BOAT),
            "B",
            "A",
            'A', new ItemStack(ItemBase.CHERRY_BOAT),
    ...
    public static void signRecipe() {
        ...
        if (Examine.FuturemcID) {
            signRecipe(Block.getBlockFromName("futuremc:bamboo"), 0, ItemBase.BAMBOO_SIGN, "bamboo");
        }
        if (Examine.UNBID) {
    ...
    public static void signRecipe(Block block, int meta, Item sign, String signType) {
        ItemStack planks = new ItemStack(block, 1, meta);
        ItemStack signStack = new ItemStack(sign, 3);

        if (!ItemBase.isValidItemStack(planks, signStack)) return;
