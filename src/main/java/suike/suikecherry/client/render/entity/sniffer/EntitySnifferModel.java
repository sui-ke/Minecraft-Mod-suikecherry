...
public class EntitySnifferModel extends ModelBase {
    private EntitySniffer sniffer;
...
// 渲染
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity) {
        this.sniffer = (EntitySniffer) entity;
        ...
        // 腿部动画
        if(this.sniffer.getState() == EntitySniffer.State.DIGGING) {
