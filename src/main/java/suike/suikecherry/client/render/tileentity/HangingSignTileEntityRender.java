...
public class HangingSignTileEntityRender extends TileEntityRender<HangingSignTileEntity> {
    ...
    private void renderText(HasBackSideSignTileEntity signTile, int slot) {
        RenderPosition renderPos = signTile.getTextRenderPosition(slot);
    ...
    private void renderItem(HangingSignTileEntity hangingSignTile, int slot) {
        ...
        RenderPosition renderPos = hangingSignTile.getItemRenderPosition(slot);
    ...
    private void applyTextTransforms(RenderPosition renderPos) {
    ...
    private void applyItemTransforms(RenderPosition renderPos) {
