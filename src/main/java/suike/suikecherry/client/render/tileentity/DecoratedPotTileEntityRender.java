...
public class DecoratedPotTileEntityRender extends TileEntityRender<DecoratedPotTileEntity> {
    ...
    private static final ThreadLocal<DecoratedPotTileEntityRender> CURRENT_RENDER = new ThreadLocal<>();
    ...
    public static class ModelDecoratedPot extends ModelBase {
        ...
        public ModelDecoratedPot(EnumFacing facing) {
            ...
            this.right = new TexModelRenderer(this, 1, 2, () -> {
                DecoratedPotTileEntityRender renderer = DecoratedPotTileEntityRender.CURRENT_RENDER.get();
                if (renderer != null) renderer.bindTexture(getPatternTexture(currentSherdIDs[0]));
            });
            ...
            this.back = new TexModelRenderer(this, 3, 0, () -> {
                DecoratedPotTileEntityRender renderer = DecoratedPotTileEntityRender.CURRENT_RENDER.get();
                if (renderer != null) renderer.bindTexture(getPatternTexture(currentSherdIDs[1]));
            });
            ...
            this.left = new TexModelRenderer(this, 3, 2, () -> {
                DecoratedPotTileEntityRender renderer = DecoratedPotTileEntityRender.CURRENT_RENDER.get();
                if (renderer != null) renderer.bindTexture(getPatternTexture(currentSherdIDs[2]));
            });
            ...
            this.front = new TexModelRenderer(this, 1, 0, () -> {
                DecoratedPotTileEntityRender renderer = DecoratedPotTileEntityRender.CURRENT_RENDER.get();
                if (renderer != null) renderer.bindTexture(getPatternTexture(currentSherdIDs[3]));
            });
