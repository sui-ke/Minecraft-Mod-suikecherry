...
// 收获
    ...
    public void harvestBlock(World world, EntityPlayer player, BlockPos pos, IBlockState state, TileEntity tile, ItemStack stack) {
        ...
        if (tile instanceof ChiseledBookShelfTileEntity) {
            this.dropStoredItem(world, pos, ((ChiseledBookShelfTileEntity) tile));
        }
    }

    private void dropStoredItem(World world, BlockPos pos, ChiseledBookShelfTileEntity tile) {
        for (ItemStack itme : tile.getAllBook()) {
            spawnAsEntity(world, pos, itme);
        }
    }
