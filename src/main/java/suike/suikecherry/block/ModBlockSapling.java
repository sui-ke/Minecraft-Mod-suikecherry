...
public class ModBlockSapling extends BlockBush implements IGrowable {
    public ModBlockSapling(String name) {
        ...
        /*设置声音*/this.setSoundType(this.type.getLeavesSound());
    ...
    private boolean customizeStateSet = true;
...
// 元数据
    ...
    protected BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, new IProperty[] {ModBlockPlanks.TYPE, STAGE});
    }
    @Override
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState()
            .withProperty(ModBlockPlanks.TYPE, this.type)
