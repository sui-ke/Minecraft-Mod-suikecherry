...
public class BlockBase extends Block {
    ...
    /*樱花木板*/public static final Block CHERRY_PLANKS = new BlockBase("cherry_planks", CreativeTabs.BUILDING_BLOCKS, ModSoundType.cherryWood);
    ...
    /*纹饰陶罐*/public static final ModBlockDecoratedPot DECORATED_POT = new ModBlockDecoratedPot("decorated_pot");
    /*嗅探兽蛋*/public static final ModBlockSnifferEgg SNIFFER_EGG = new ModBlockSnifferEgg("sniffer_egg");

//构造函数
    public BlockBase(String name, CreativeTabs tabs, SoundType soundType) {
        super(Material.WOOD);
