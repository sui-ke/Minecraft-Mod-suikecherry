...
//落英属性
    ...
    //元数据列表
    /*元数据列表1: 状态 > 元数据*/private Map<List<Integer>, Integer> metaMap = new HashMap<>();
    /*元数据列表2: 元数据 > 状态*/private Map<Integer, List<Integer>> metaReverseMap = new HashMap<>();
    //初始化元数据列表
...
//轮廓箱&碰撞箱
    private static Map<Integer, AxisAlignedBB> metaBoxMap = new HashMap<>();
