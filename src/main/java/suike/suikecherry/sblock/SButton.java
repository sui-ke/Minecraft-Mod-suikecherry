...
//按钮交互
    ...
    public void playClickSound(EntityPlayer player, World world, BlockPos pos) {
        /*播放点击声音*/world.playSound(null, pos, new SoundEvent(new ResourceLocation(SuiKe.MODID, "block.cherrybutton.click")), SoundCategory.BLOCKS, 2.0F, 1.0F);
        /*持续30 ticks*/world.scheduleUpdate(pos, this, 30);
    }
    @Override
    public void playReleaseSound(World world, BlockPos pos) {
        /*播放点击声音*/world.playSound(null, pos, new SoundEvent(new ResourceLocation(SuiKe.MODID, "block.cherrybutton.restore")), SoundCategory.BLOCKS, 2.0F, 1.0F);
    }
}