...
public class CherryTree {
    ...
    private static void 生成樱花树(World world, BlockPos pos, Random random, boolean isSapling) {
        ...
        a = treeAm;
        treeAm++;
        if (treeAm >= 樱花树List.size()) {treeAm = 0;}
        System.out.println("生长第: " + a + "棵树");
        */
        ...
        if (isSapling) {
            ...
            //自然生成
            random = new Random(world.getSeed() + pos.getX() * 745 + 164 + pos.getZ() * 357 + 256);
            a = random.nextInt(樱花树List.size());
        }
